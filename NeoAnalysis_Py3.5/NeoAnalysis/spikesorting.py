...
class SpikeSorting():
    ...
    def __err_msg(self):
        err_msg = QtWidgets.QMessageBox()
        err_msg.setIcon(QtWidgets.QMessageBox.Information)
        err_msg.setText("An error happened when trying to execute SPC.\nThis may be due to the incompatibility of the independent execute app for SPC.\nThe softeware is tested on mac os 64 bit, ubuntu 32bit and 64bit, win7 32bit and win10 64bit.\nPlease contact us through zhangbo_1008@163.com , we are happy to help you fix this problem together\nWhile you can still use the manual sorting method.")
