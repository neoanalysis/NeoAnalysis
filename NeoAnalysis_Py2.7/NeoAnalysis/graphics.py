...
class Graphics():
    ...
    def plot_spectral(self,channel,sort_by,align_to,pre_time,post_time,limit=False,filter_nan=False,x_lim=[1,100],y_lim=False,log=False,fig_size=[12,7]):
        '''
        Args
            channel (string): 
                define the analog channel
        ...
        f_spec = lambda ite:signal.periodogram(ite,fs)
    ...
    def __spectrogram(self,data,samp_rate,per_lap=0.9,wlen=None,mult=8.0):
    ...
    def plot_spectrogram(self,channel,sort_by,align_to,pre_time,post_time,limit=False,filter_nan=False,y_lim=[0,100],normalize=True,fig_mark=[0],fig_size=[12,7],color_bar=True,fig_column=4):
        '''
        Args
            channel (string): 
                define the analog channel
        ...
        if normalize is True:
            for i,value in enumerate(ana_select):
                i_specg,i_freq,i_time = self.__spectrogram(value,fs)
