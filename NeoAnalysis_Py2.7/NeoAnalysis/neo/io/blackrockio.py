...
class BlackrockIO(BaseIO):
    ...
    def __transform_nsx_to_load(self, nsx_to_load):
        ...
        return nsx_to_load
    def __transform_channels(self,channels):
        """
        ...
        return channels
    def __transform_channels_old(self, channels, nsx_to_load):
        """
        Transforms the input argument channels to a list of integers.
        """
        all_channels = []
    ...
    def read_segment(
        ...
        nsx_to_load = self.__transform_nsx_to_load(nsx_to_load)
        # Arg: channels
        channels = self.__transform_channels(channels)
        # Arg: units
        ...
        if self._avail_files['nev']:
            ...
            if load_events:
                ...
                # read Comments
                ev = self.__read_comment(
                    n_start=n_start,
                    n_stop=n_stop,
                    data=nev_data['Comments'],
                    lazy=lazy)
